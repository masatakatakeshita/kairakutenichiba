...
values
(1,'チビモン','少年漫画','2099-12-31','佐藤次郎','快楽社','漫画',178,9784123456789,480,1000,"商品詳細","img/items/チビモン.png"),
(2,'メガネ','文庫本','2099-12-31','鈴木花子','快楽社','文庫',382,9784123789456,650,1000,"商品詳細","img/items/メガネ.png"),
(3,'ライオンの飼育方法','ライトノベル','2099-12-31','佐藤次郎','快楽社','文庫',282,9784789456123,480,1000,"商品詳細","img/items/ライオンの飼育方法.png"),
(4,'ワイルドフラワー','少女漫画','2099-12-31','山田太郎','快楽社','漫画',180,9874159324786,440,1000,"商品詳細","img/items/ワイルドフラワー.png"),
(5,'快楽店市場の歴史','雑誌','2099-12-31','山田太郎','快楽社','雑誌',60,9874741236985,440,1000,"商品詳細","img/items/快楽店市場の歴史.png"),
(6,'世界の絶景','雑誌','2099-12-31','山田太郎','快楽社','雑誌',64,9874147896325,520,1000,"商品詳細","img/items/世界の絶景.png"),
(7,'正しい寿司の握り方','雑誌','2099-12-31','鈴木花子','快楽社','雑誌',45,9874852147963,490,1000,"商品詳細","img/items/正しい寿司の握り方.png"),
(8,'美しいホネ','ライトノベル','2099-12-31','山田太郎','快楽社','文庫',215,9874963258741,620,1000,"商品詳細","img/items/美しい骨.png"),
(9,'名探偵コナソ','少年漫画','2099-12-31','赤山剛昌','快楽社','漫画',186,9874147963258,460,1000,"商品詳細","img/items/名探偵コナソ.png"),
(10,'僕に届け','少女漫画','2099-12-31','椎名重穂','快楽社','漫画',186,9874951463782,460,1000,"商品情報","img/items/僕に届け.png"),
(11,'ノルウェイの林(上)','文庫本','2099-12-31','村上冬樹','快楽社','文庫',300,9874456987321,600,1000,"商品情報","img/items/ノルウェイの林（上）.png"),
(12,'ノルウェイの林(下)','文庫本','2099-12-31','村上冬樹','快楽社','文庫',300,9874456986321,600,1000,"商品情報","img/items/ノルウェイの林（下）.png"),
(13,'俺の姉がこんなに可愛いわけがない','ライトノベル','2099-12-31','伏目つかさ','快楽社','文庫',264,92874197842136,460,1000,"商品情報","img/items/俺の姉が.png"),
(14,'頭文字C','少年漫画','2099-12-31','しげの秀二','快楽社','漫画',196,9874102365478,420,1000,"商品情報","img/items/頭文字C.png"),
(15,'ねだめ　カンタービレ','少女漫画','2099-12-31','三ノ宮知子','快楽社','漫画',192,9874102512305,420,1000,"商品情報","img/items/ねだめ カンタービレ.png");
